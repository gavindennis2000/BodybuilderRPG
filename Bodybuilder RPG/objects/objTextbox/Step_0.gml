...
var confirm = input_check_pressed("south") || TEST && input_check("east");
var finishText = input_check_pressed("west") || TEST && input_check("east");
